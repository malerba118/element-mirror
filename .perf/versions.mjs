...
/** Shoots every demo section, for eyeballing after a change. */
...
await page.waitForTimeout(1500)
await specimen.screenshot({ path: `${OUT}/gallery.png` })
await page.getByRole('button', { name: 'difference' }).first().click()
await page.waitForTimeout(1500)
await specimen.screenshot({ path: `${OUT}/difference.png` })
